...
public final class ShipTierAttachment {
	private final HashMap<Long, Integer> tierMods = new HashMap<>();

	public void addTierMod(final BlockPos pos, final int tier) {
		tierMods.put(pos.asLong(), tier);
	}

	public void removeTierMod(final BlockPos pos) {
