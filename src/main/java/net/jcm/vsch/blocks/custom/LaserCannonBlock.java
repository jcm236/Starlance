...
import net.jcm.vsch.blocks.entity.laser.AbstractLaserBlockEntity;
...
public abstract class LaserCannonBlock<T extends AbstractLaserBlockEntity> extends AbstractCannonBlock<T> {
