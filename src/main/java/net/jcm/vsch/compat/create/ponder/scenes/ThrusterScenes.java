...
public class ThrusterScenes {
	...
	public static void thrusters(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.effects().emitParticles(util.vector().of(2.5, 1.5, 3.5), scene.effects().simpleParticleEmitter(VSCHParticleTypes.THRUST.get(), new Vec3(0, 0, -10)), 2, 10);
		...
		scene.effects().emitParticles(util.vector().of(3.5, 1.5, 3.5), scene.effects().simpleParticleEmitter(VSCHParticleTypes.THRUST.get(), new Vec3(0, 0, -10)), 2, 10);
		scene.effects().emitParticles(util.vector().of(1.5, 1.5, 3.5), scene.effects().simpleParticleEmitter(VSCHParticleTypes.THRUST.get(), new Vec3(0, 0, -10)), 2, 10);

		scene.idle(10);

		scene.effects().emitParticles(util.vector().of(3.5, 1.5, 6.5), scene.effects().simpleParticleEmitter(VSCHParticleTypes.THRUST.get(), new Vec3(0, 0, -10)), 2, 10);

		scene.idle(15);

		scene.effects().emitParticles(util.vector().of(3.5, 1.5, 9), scene.effects().simpleParticleEmitter(VSCHParticleTypes.THRUST.get(), new Vec3(0, 0, -10)), 2, 10);
